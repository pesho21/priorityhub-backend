...
CREATE TABLE "Task" (
    ...
    "timeSpentOnTask" INTEGER NOT NULL,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
-- CreateTable
CREATE TABLE "_TaskNotifications" (
    "A" TEXT NOT NULL,
    "B" TEXT NOT NULL
);
...
-- CreateIndex
CREATE UNIQUE INDEX "_TaskNotifications_AB_unique" ON "_TaskNotifications"("A", "B");

-- CreateIndex
CREATE INDEX "_TaskNotifications_B_index" ON "_TaskNotifications"("B");
...
-- AddForeignKey
ALTER TABLE "_TaskNotifications" ADD CONSTRAINT "_TaskNotifications_A_fkey" FOREIGN KEY ("A") REFERENCES "Notification"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_TaskNotifications" ADD CONSTRAINT "_TaskNotifications_B_fkey" FOREIGN KEY ("B") REFERENCES "Task"("id") ON DELETE CASCADE ON UPDATE CASCADE;
